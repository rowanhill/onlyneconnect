...
import { expectRevealedCluesToBe, answersHistory, scoreboard, answerInput, answerSubmit, finalClue } from '../pages/quizPage';
import { CreateConnectionOrSequenceQuestionResult } from '../plugins';

describe('Playing a sequence question', () => {
    let quizId: string;
    let teamId: string;
    ...
    describe('as a team member', () => {
        it('shows questions, clues, answers and scores as they are revealed / submitted', () => {
            ...
            expectRevealedCluesToBe(['Q1 C1', 'Q1 C2', 'Q1 C3']);
